    ...
    <div class="row">
      <div class="col-md-8 col-12 section-5__left px-3">
        ...
        <div class="promotional-products__content row">
				...
				<a href="product-details.html#13" target="_blank" class="link-to-product"><img src="images/sp-khuyen-mai/hu-xoan-ong.png" class="card-img" alt="Hũ xoắn ong" title="Hũ xoắn ong"></a>
				</div>
				<div class="col-md-7 col-12">
				<div class="card-body">
				<h6 class="card-title product-title promotional-products__title">Hũ xoắn ong</h6>
				<p class="card-text promotional-products__new-price">10.000 <sup>đ</sup></p>
				<p class="card-text promotional-products__old-price">15.000 <sup>đ</sup></p>
				</div>
				</div>
				</div>
				<div class="overlay2">
				...
				<div class="wrap-card2 wrap-card2-1 col-sm-6 col-12">
				<div data-id="15" class="card">
				<div class="row no-gutters">
				<div class="col-md-5 col-12 promotional-products__img">
				<a href="product-details.html#15" target="_blank" class="link-to-product"><img src="images/sp-khuyen-mai/chai-xit-phun-suong.png" class="card-img" alt="Chai phun sương" title="Chai phun sương"></a>
				</div>
				<div class="col-md-7 col-12">
				<div class="card-body">
				<h6 class="card-title product-title promotional-products__title">Chai phun sương</h6>
				<p class="card-text promotional-products__new-price">18.000 <sup>đ</sup></p>
				<p class="card-text promotional-products__old-price">25.000 <sup>đ</sup></p>
				</div>
				</div>
				</div>
				<div class="overlay2">
				...
				<div class="wrap-card2 wrap-card2-2 col-sm-6 col-12">
				<div data-id="01" class="card">
				<div class="row no-gutters">
				<div class="col-md-5 col-12 promotional-products__img">
				<a href="product-details.html#01" target="_blank" class="link-to-product"><img src="images/sp-khuyen-mai/hu-nap-bac.png" class="card-img" alt="Hũ nắp bạc" title="Hũ nắp bạc"></a>
				</div>
				<div class="col-md-7 col-12">
				<div class="card-body">
				<h6 class="card-title product-title promotional-products__title">Hũ nắp bạc</h6>
				<p class="card-text promotional-products__new-price">17.000 <sup>đ</sup></p>
				<p class="card-text promotional-products__old-price">22.000 <sup>đ</sup></p>
				</div>
				</div>
				</div>
				<div class="overlay2">
				...
				<div class="wrap-card2 wrap-card2-3 col-sm-6 col-12">
				<div data-id="11" class="card">
				<div class="row no-gutters">
				<div class="col-md-5 col-12 promotional-products__img">
				<a href="product-details.html#11" target="_blank" class="link-to-product"><img src="images/sp-khuyen-mai/chai-bong-den.png" class="card-img" alt="Chai bóng đèn" title="Chai bóng đèn"></a>
				</div>
				<div class="col-md-7 col-12">
				<div class="card-body">
				<h6 class="card-title product-title promotional-products__title">Chai bóng đèn</h6>
				<p class="card-text promotional-products__new-price">25.000 <sup>đ</sup></p>
				<p class="card-text promotional-products__old-price">31.000 <sup>đ</sup></p>
				</div>
				</div>
				</div>
				<div class="overlay2">
				...
				<div class="wrap-card2 wrap-card2-4 col-sm-6 col-12">
				<div data-id="14" class="card">
				<div class="row no-gutters">
				<div class="col-md-5 col-12 promotional-products__img">
				<a href="product-details.html#14" target="_blank" class="link-to-product"><img src="images/sp-khuyen-mai/hu-nhom.png" class="card-img" alt="Hũ nhôm" title="Hũ nhôm"></a>
				</div>
				<div class="col-md-7 col-12">
				<div class="card-body">
				<h6 class="card-title product-title promotional-products__title">Hũ nhôm</h6>
				<p class="card-text promotional-products__new-price">12.000 <sup>đ</sup></p>
				<p class="card-text promotional-products__old-price">20.000 <sup>đ</sup></p>
				</div>
				</div>
				</div>
				<div class="overlay2">
				...
				<div class="wrap-card2 wrap-card2-5 col-sm-6 col-12">
				<div data-id="12" class="card">
				<div class="row no-gutters">
				<div class="col-md-5 col-12 promotional-products__img">
				<a href="product-details.html#12" target="_blank" class="link-to-product"><img src="images/sp-khuyen-mai/lo-tinh-dau-treo-xe.png" class="card-img" alt="Lọ t.dầu treo xe" title="Lọ t.dầu treo xe"></a>
				</div>
				<div class="col-md-7 col-12">
				<div class="card-body">
				<h6 class="card-title product-title promotional-products__title">Lọ t.dầu treo xe</h6>
				<p class="card-text promotional-products__new-price">20.000 <sup>đ</sup></p>
				<p class="card-text promotional-products__old-price">27.000 <sup>đ</sup></p>
				</div>
				</div>
				</div>
				<div class="overlay2">
